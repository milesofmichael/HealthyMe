...
final class LoggerService: LoggerServiceProtocol {
    ...
    private let logger = Logger(subsystem: "com.healthyme", category: "app")

    func log(_ message: String, level: LogLevel, file: String, line: Int) {
        // Extract just the file name from the fileID (e.g., "HealthyMe/HealthCache.swift" -> "HealthCache")
    ...
    /// Example: "HealthyMe/Services/Cache/HealthCache.swift" -> "HealthCache"
